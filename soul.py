...
TOKEN = '7799210668:AAFSLLeQzaV_Yvo5a-m_nXZGk6LRemytxJY'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002350790418
CHANNEL_ID = -1002350790418
error_channel_id = -1002350790418
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@Yash_Cheat*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :- @Yash_Cheat*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("YASH SERVER RUNNING.....")
    while True:
        try:
